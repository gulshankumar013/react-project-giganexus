...
const API = "http://localhost:5164/fetchAllUser"; // Assuming this endpoint is correct
const DELETE_API = "http://localhost:5164/delete"; // New endpoint for deleting user
